                ...
                <div id="page-wrapper" style={{}}>
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <form action="/MOC/EditMilestone/1" method="post"><input name="__RequestVerificationToken" type="hidden" defaultValue="uTkCnCRrBSEn1GqbxnDN2zQRDxQWcXwX7TRgbFaYIbSvTDseyvFvQVtHBJX4YY2vM1_KvVf5OKY-T_0X53tpKzmO7IlUufkx-33vGXpg2jd_GweYv8WMinUfGIQawRs80" />    <div className="form-horizontal">
                                <hr />
                                <input data-val="true" data-val-number="The field MilestoneID must be a number." data-val-required="The CourseID field is required." id="CourseID" name="CourseID" type="hidden" defaultValue={1} />
                                ...
                                <div className="form-group">
                                    <label className="control-label col-md-2" htmlFor="CreditHrs">Due Date</label>
                                    <div className="col-md-10">
