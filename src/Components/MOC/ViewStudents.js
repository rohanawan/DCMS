                ...
                <div id="page-wrapper" style={{}}>
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <h2>Student</h2>
                            <form action="/MOC/Student" method="get" onsubmit="return check(this) && false;">        <div style={{ display: 'flex' }}>
                            ...
                            <br />
                            <form action="/MOC/DeleteStudentMultiple" method="post" onsubmit="return confirmDelete(this) && false;"><table className="table table-striped table-condensed table-bordered">
                                <tbody><tr>
                                    <th>
                                    </th>
                                    <th>
                                        <a href="/MOC/Student?sortOrder=name_desc">Name</a>
                                    </th>
                                    <th>
                                        Registration No.
                </th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <Link to="/MOC/Student/AssignCourse" className="btn btn-primary">Assign Course</Link>
                                        </td>
                                        <td>
                                            <Link to="/MOC/EditStudent">Edit</Link> |
                                            <Link to="/MOC/DetailsStudent">Details</Link> |
                                            <a href="/MOC/DeleteStudent">Delete</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
