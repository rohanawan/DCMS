                ...
                <div id="page-wrapper" style={{}}>
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <br /> <hr></hr>
                            <form action="/HOD/Student" method="post" onsubmit="return confirmDelete(this) && false;"><table className="table table-striped table-condensed table-bordered">
                                <tbody><tr>
                                    {/* <th>
                                    </th> */}
                                    <th>
