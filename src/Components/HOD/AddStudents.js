                ...
                <div id="page-wrapper" style={{}}>
                    <div className="row">
                        <div className="col-lg-12">
                            <h2>Add Student</h2>
                            <form action="HOD/CreateStudent" method="post"><input name="__RequestVerificationToken" type="hidden" defaultValue="Pxn325IjnUF3956qEvOuuEStf-j6oo9Gulpsb7VXhHiPIjbMiwiX6ox-DfYvSpqFj8HsmNjvN8vjQR5ap8yPEqaAmjlHjbytUbnM6XFPuKtndKy9BDW0-zAvCAWdKU770" />    <div className="form-horizontal">
                                <hr />
