            ...
            <div>
                <header className="top" style={{ backgroundColor: '#2c3e50' }}>
                    <div className="container">
                        <a href="/HOD" className="navbar-brand" style={{ color: 'white', marginLeft: 22 }}>
                        ...
                        <div className="navbar-collapse collapse">
                            <ul className="nav navbar-nav" style={{ float: 'right' }} id="topLink">
                                <li className="active"><Link to="/HOD">Home</Link></li>
                                <li><a href="/HOD">About</a></li>
                                <li><a href="/HOD">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div id="Dialog-Box" style={{ display: 'none' }}>
                    <div style={{ margin: 20 }}>
                        ...
                        <div style={{ display: 'inline-block' }}>
                            <p style={{ fontSize: 20, display: '-webkit-inline-box' }}> HOD</p>
                            <p>HOD@HOD.com</p>
                        </div>
                        <div style={{ marginTop: 32 }}>
                            <a className="btn btn-info" href="/HOD" style={{ float: 'left' }}>Change Password</a>
