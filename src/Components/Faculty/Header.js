                    ...
                    <div className="container">
                        ...
                        <div className="navbar-collapse collapse">
                            <ul className="nav navbar-nav" style={{ float: 'right' }} id="topLink">
                                <li className="active"><Link to="/Faculty">Home</Link></li>
                                <li><a href="/Faculty">About</a></li>
                                <li><a href="/Faculty">Notification</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div id="Dialog-Box" style={{ display: 'none' }}>
                    <div style={{ margin: 20 }}>
                        ...
                        <div style={{ display: 'inline-block' }}>
                            <p style={{ fontSize: 20, display: '-webkit-inline-box' }}> Faculty</p>
                            <p>faculty@faculty.com</p>
                        </div>
                        <div style={{ marginTop: 32 }}>
                            <a className="btn btn-info" href="/Faculty" style={{ float: 'left' }}>Change Password</a>
