                ...
                <div id="page-wrapper" style={{}}>
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <form action="/HOC/EditCourse/1" method="post"><input name="__RequestVerificationToken" type="hidden" defaultValue="uTkCnCRrBSEn1GqbxnDN2zQRDxQWcXwX7TRgbFaYIbSvTDseyvFvQVtHBJX4YY2vM1_KvVf5OKY-T_0X53tpKzmO7IlUufkx-33vGXpg2jd_GweYv8WMinUfGIQawRs80" />    <div className="form-horizontal">
                                <hr />
                                ...
                                <div className="form-group">
                                    <label className="control-label col-md-2" htmlFor="Name">CommitteeName</label>
                                ...
                                <div className="form-group">
                                    <label className="control-label col-md-2" htmlFor="Name">CommitteeGoal</label>
                                    <div className="col-md-10">
                                        <input className="form-control text-box single-line" data-val="true" data-val-required="The Name field is required." id="Name" name="Name" type="text" defaultValue="Database" />
                                        <span className="field-validation-valid" data-valmsg-for="Name" data-valmsg-replace="true" />
                                    </div>
                            ...
                            <div>
                                <Link to="/HOC/Committees">Back to List</Link>
                            </div>
