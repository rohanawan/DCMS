            ...
            <div>
                <header className="top" style={{ backgroundColor: '#2c3e50' }}>
                    <div className="container">
                        <a href="/Student" className="navbar-brand" style={{ color: 'white', marginLeft: 22 }}>
                        ...
                        <div className="navbar-collapse collapse">
                            <ul className="nav navbar-nav" style={{ float: 'right' }} id="topLink">
                                <li className="active"><Link to="/Student">Home</Link></li>
                                <li><a href="/Student">About</a></li>
                ...
                <div id="Dialog-Box" style={{ display: 'none' }}>
                    <div style={{ margin: 20 }}>
                        ...
                        <div style={{ display: 'inline-block' }}>
                            <p style={{ fontSize: 20, display: '-webkit-inline-box' }}> Student</p>
                            <p>Student@gmail.com</p>
                        </div>
                        <div style={{ marginTop: 32 }}>
                            <a className="btn btn-info" href="/Student" style={{ float: 'left' }}>Change Password</a>
